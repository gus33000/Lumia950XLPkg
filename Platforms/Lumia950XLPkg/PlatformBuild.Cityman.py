# @file
# Script to Build Lumia950XL Mu UEFI firmware
#
...
class CommonPlatform():
    ...
    '''
    PackagesSupported = ("Lumia950XLPkg",)
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE", "NOOPT")
    Scopes = ('Lumia950XL', 'edk2-build', 'cibuild')
...
class SettingsManager(UpdateSettingsManager, SetupSettingsManager, PrEvalSettingsManager):
    ...
    def GetPlatformDscAndConfig(self) -> tuple:
        ...
        '''
        return ("Lumia950XLPkg/Lumia950XL.dsc", {})
...
class PlatformBuilder( UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv(self):
        ...
        self.env.SetValue("PRODUCT_NAME", "Lumia950XL", "Platform Hardcoded")
        self.env.SetValue("ACTIVE_PLATFORM", "Lumia950XLPkg/Lumia950XL.dsc", "Platform Hardcoded")
