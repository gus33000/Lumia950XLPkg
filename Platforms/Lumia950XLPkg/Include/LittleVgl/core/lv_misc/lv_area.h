 ...
 */
void lv_area_set(
    lv_area_t *area_p, lv_coord_t x1, lv_coord_t y1, lv_coord_t x2,
    lv_coord_t y2);
 ...
 */
bool lv_area_intersect(
    lv_area_t *res_p, const lv_area_t *a1_p, const lv_area_t *a2_p);
 ...
 */
void lv_area_join(
    lv_area_t *a_res_p, const lv_area_t *a1_p, const lv_area_t *a2_p);
