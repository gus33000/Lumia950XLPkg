...
typedef struct {
  ...
  bool (*read)(
      lv_indev_data_t *data); /*Function pointer to read data. Return 'true' if
                                 there is still data to be read (buffered)*/
...
typedef struct _lv_indev_t {
  ...
  union {
    ...
    lv_point_t *btn_points; /*Array points assigned to the button ()screen will
                               be pressed here by the buttons*/
  };
